...
const Perks = ({selected, onChange}) => {
    ...
    return (
    <>
    <div className='grid mt-4 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-auto  cursor-pointer'>
                    <label className='border p-4 flex rounded-2xl items-center gap-2 cursor-pointer'>
                            ...
                            <label className='border p-1 flex rounded-2xl items-center gap-2 cursor-pointer'>
